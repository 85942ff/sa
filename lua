...
local function setupUI()
    ...
    do
        local BulletTraceGroup = Tabs.Ohio:AddRightGroupbox('子弹追踪')
        BulletTraceGroup:AddToggle('bulletTrace', {
            Text = '启用子弹追踪',
            Default = false,
            Callback = function(s)
        ...
        BulletTraceGroup:AddColorPicker('bulletTraceFovColor', {
            Text = 'FOV圈颜色',
            Default = bulletTraceFovColor,
            Callback = function(value)
                bulletTraceFovColor = value
                updateFovAppearance()
            end
        })
        BulletTraceGroup:AddSlider('bulletTraceFovRadius', {
            Text = 'FOV圈半径',
            Min = 50,
            Max = 500,
            Default = bulletTraceFovRadius,
            Rounding = 0,
            Suffix = 'px',
            Callback = function(value)
                bulletTraceFovRadius = value
                updateFovAppearance()
            end
        })
        BulletTraceGroup:AddSlider('bulletTraceMaxDist', {
            Text = '最大追踪距离',
            Min = 100,
            Max = 5000,
            Default = bulletTraceMaxDist,
            Rounding = 0,
            Suffix = ' studs',
            Callback = function(value)
                bulletTraceMaxDist = value
            end
        })
    end
